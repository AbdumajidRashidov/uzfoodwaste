 ...
 *     description: Retrieve a category by its ID including associated listings
 *     tags: [Categories]
 *     parameters:
 *       - in: path
 *         name: categoryId
 ...
 *       400:
 *         description: Cannot delete category with associated listings
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: Cannot delete category that is being used by listings
 *       401:
 *         $ref: '#/components/responses/UnauthorizedError'
 *       403:
 *         $ref: '#/components/responses/ForbiddenError'
 ...
 *             listings:
 *               type: integer
 *               description: Number of listings in this category
 *               example: 15
 *         listings:
 *           type: array
 *           items:
 *             $ref: '#/components/schemas/ListingCategory'
 *           description: Associated food listings (only included in detailed view)
 *
 *     ListingCategory:
 *       type: object
 *       properties:
